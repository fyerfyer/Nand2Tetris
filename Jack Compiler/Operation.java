...
public class Operation {
    ...
    public static ArrayList<String> subList(ArrayList<String> arrayList, int index) {
        ArrayList<String> resultArrayList = new ArrayList<>();

        resultArrayList.addAll(arrayList.subList(index, arrayList.size()));
        return resultArrayList;
    }

    public static ArrayList<String> selectContent(ArrayList<String> line) {
